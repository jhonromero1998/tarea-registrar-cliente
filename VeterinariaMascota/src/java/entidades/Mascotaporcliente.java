...
public class Mascotaporcliente  implements java.io.Serializable {
    ...
    public Mascotaporcliente(MascotaporclienteId id, Cliente cliente, Mascota mascota, String estado) {
        this.id = id;
        this.cliente = cliente;
        this.mascota = mascota;
        this.estado = estado;
    }
    public Mascotaporcliente(MascotaporclienteId id, Cliente cliente, Mascota mascota, String estado, Set atencions) {
       this.id = id;
       this.cliente = cliente;
       this.mascota = mascota;
       this.estado = estado;
